package com.userservice.controllers.api;
...
public interface UserControllerApi {
    ...
    @ApiResponses({
            ...
            @ApiResponse(responseCode = "400", description = "Invalid request", content = @Content(schema = @Schema(implementation = com.userservice.exceptions.ErrorResponse.class))),
    ...
    @ApiResponses({
            ...
            @ApiResponse(responseCode = "400", description = "Validation failed", content = @Content(schema = @Schema(implementation = com.userservice.exceptions.ErrorResponse.class)))
    })
